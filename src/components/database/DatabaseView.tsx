  ...
  const tablesData = [
    {
      ...
      icon: 'devices',
      description: 'Inventario de activos individuales con código de barra, serial, ficha técnica JSONB y estado físico.',
      columns: [
        { name: 'id', type: 'UUID', pk: true, nullable: false, desc: 'Identificador único del activo' },
        { name: 'serial_number', type: 'VARCHAR(100)', unique: true, nullable: false, desc: 'Número de serie de fábrica' },
        { name: 'asset_code', type: 'VARCHAR(100)', unique: true, nullable: false, desc: 'Código de placa institucional' },
        { name: 'name', type: 'VARCHAR(200)', nullable: false, desc: 'Nombre descriptivo del equipo' },
        { name: 'category_id', type: 'UUID', fk: 'product_categories.id', nullable: true, desc: 'Familia patrimonial' },
        { name: 'environment_id', type: 'TEXT', fk: 'environments.id', nullable: false, desc: 'Ambiente físico asignado' },
        { name: 'station', type: 'VARCHAR(100)', nullable: false, desc: 'Puesto de trabajo específico' },
        { name: 'physical_status', type: 'asset_status_type', nullable: false, desc: 'operativo | mesa_servicio | con_dano' },
        { name: 'responsible_person', type: 'VARCHAR(150)', nullable: false, desc: 'Custodio o docente titular' },
        { name: 'barcode', type: 'VARCHAR(100)', nullable: false, desc: 'Código de barras GS1-128' },
        { name: 'qr_token', type: 'VARCHAR(150)', nullable: false, desc: 'Token QR de verificación' },
        { name: 'specs', type: 'JSONB', nullable: true, desc: 'Especificaciones técnicas (RAM, CPU, etc.)' }
      ]
    },
    {
