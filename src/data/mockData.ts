...
import { generateWeeklyPhysicalSchedules } from '../utils/scheduleWeekUtils';
...
export const INITIAL_PHYSICAL_SCHEDULES: PhysicalInventorySchedule[] = generateWeeklyPhysicalSchedules(INITIAL_ENVIRONMENTS);
