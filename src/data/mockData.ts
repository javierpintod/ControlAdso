...
export const INITIAL_ENVIRONMENTS: Environment[] = [
  {
    ...
    assignedInstructorId: 'usr-inst-1',
    assignedInstructorName: 'Ing. Carlos Andrés Méndez',
    assignedInstructorEmail: 'carlos.mendez@sena.edu.co',
  ...
  },
  {
    ...
    assignedInstructorId: 'usr-inst-2',
    assignedInstructorName: 'Lic. Laura Sofía Vargas',
    assignedInstructorEmail: 'laura.vargas@sena.edu.co',
  ...
  },
  {
    ...
    assignedInstructorId: 'usr-inst-3',
    assignedInstructorName: 'Prof. Fernando Ortiz',
    assignedInstructorEmail: 'fernando.ortiz@sena.edu.co',
  ...
  },
  {
    ...
    assignedInstructorId: 'usr-inst-4',
    assignedInstructorName: 'Ing. Diana Marcela Morales',
    assignedInstructorEmail: 'diana.morales@sena.edu.co',
  ...
  },
  {
    ...
    assignedInstructorId: 'usr-inst-5',
    assignedInstructorName: 'Custodio Roberto Gómez',
    assignedInstructorEmail: 'roberto.gomez@sena.edu.co',
...
export const INITIAL_USERS: User[] = [
  ...
  {
    id: 'usr-inst-1',
    name: 'Ing. Carlos Andrés Méndez',
    email: 'carlos.mendez@sena.edu.co',
    role: 'tecnico',
    roleTitle: 'Instructor Titular Robótica e IA',
    authorizedEnvironments: ['Amb. 1: Lab Robótica'],
    lastLogin: 'Hoy 06:15 AM',
  ...
  {
    id: 'usr-inst-2',
    name: 'Lic. Laura Sofía Vargas',
    email: 'laura.vargas@sena.edu.co',
    role: 'tecnico',
    roleTitle: 'Instructora Cómputo & Redes',
    authorizedEnvironments: ['Amb. 2: Aula Cómputo'],
    lastLogin: 'Hoy 07:30 AM',
  ...
  {
    id: 'usr-inst-3',
    name: 'Prof. Fernando Ortiz',
    email: 'fernando.ortiz@sena.edu.co',
    role: 'tecnico',
    roleTitle: 'Instructor Taller Electrónica',
    authorizedEnvironments: ['Amb. 3: Electrónica'],
    lastLogin: 'Hoy 11:58 AM',
  ...
  {
    id: 'usr-inst-4',
    name: 'Ing. Diana Marcela Morales',
    email: 'diana.morales@sena.edu.co',
    role: 'tecnico',
    roleTitle: 'Líder Técnico Mesa de Ayuda',
    authorizedEnvironments: ['Mesa de Servicio'],
  ...
  {
    id: 'usr-inst-5',
    name: 'Custodio Roberto Gómez',
    email: 'roberto.gomez@sena.edu.co',
    role: 'tecnico',
    roleTitle: 'Custodio Almacén de Bajas / RAEE',
    authorizedEnvironments: ['Almacén Dañados'],
...
export const INITIAL_PHYSICAL_SCHEDULES: PhysicalInventorySchedule[] = [
  // Ambiente 1: Lab Robótica e IA (Instructor Carlos Andrés Méndez)
  {
    id: 'sched-amb1-06',
    environmentId: 'amb1',
    environmentName: 'Ambiente 1: Lab Robótica e IA',
    instructorId: 'usr-inst-1',
    instructorName: 'Ing. Carlos Andrés Méndez',
    instructorEmail: 'carlos.mendez@sena.edu.co',
    date: '2026-09-17',
    shift: '06:00',
    shiftLabel: '06:00 AM • Apertura de Taller',
    ...
    completedBy: 'Ing. Carlos Andrés Méndez',
    notes: 'Toma física completa. 19/19 equipos verificados con lector óptico en estaciones.',
    alertSent: false
  },
  {
    id: 'sched-amb1-12',
    ...
    date: '2026-09-17',
    shift: '12:00',
    shiftLabel: '12:00 M • Cambio de Jornada',
    deadlineTime: '12:30 PM',
    status: 'COMPLETADA',
    totalItems: 19,
    verifiedCount: 19,
    missingCount: 0,
    completedAt: '12:12 PM',
    completedBy: 'Ing. Carlos Andrés Méndez',
    notes: 'Verificación del mediodía exitosa. Todos los kits de robótica completos.',
    alertSent: false
  },
  {
    id: 'sched-amb1-18',
    ...
    date: '2026-09-17',
    shift: '18:00',
    shiftLabel: '06:00 PM • Cierre Nocturno',
  ...
  // Ambiente 2: Aula Cómputo & Redes (Instructora Laura Sofía Vargas)
  {
    id: 'sched-amb2-06',
    environmentId: 'amb2',
    environmentName: 'Ambiente 2: Aula Cómputo & Redes',
    instructorId: 'usr-inst-2',
    instructorName: 'Lic. Laura Sofía Vargas',
    instructorEmail: 'laura.vargas@sena.edu.co',
    date: '2026-09-17',
    shift: '06:00',
    shiftLabel: '06:00 AM • Apertura de Taller',
    deadlineTime: '06:30 AM',
    ...
    verifiedCount: 25,
    missingCount: 0,
    completedAt: '06:24 AM',
    completedBy: 'Lic. Laura Sofía Vargas',
    notes: '25 estaciones all-in-one y portátiles cotejados contra seriales.',
    alertSent: false
  },
  {
    id: 'sched-amb2-12',
  ...
  // Ambiente 3: Taller de Electrónica (Instructor Fernando Ortiz)
  {
    id: 'sched-amb3-06',
    environmentId: 'amb3',
    environmentName: 'Ambiente 3: Taller de Electrónica',
    instructorId: 'usr-inst-3',
    instructorName: 'Prof. Fernando Ortiz',
    instructorEmail: 'fernando.ortiz@sena.edu.co',
    date: '2026-09-17',
    shift: '06:00',
    shiftLabel: '06:00 AM • Apertura de Taller',
    deadlineTime: '06:30 AM',
  ...
  },
  {
    ...
    completedBy: 'Prof. Fernando Ortiz',
    notes: 'Equipos de osciloscopio y bancos de trabajo verificados.',
    alertSent: false
  },
  {
    id: 'sched-amb3-18',
  ...
  // Mesa de Servicio
  {
    ...
    environmentName: 'Mesa de Servicio & Diagnóstico',
    instructorId: 'usr-inst-4',
    instructorName: 'Ing. Diana Marcela Morales',
    instructorEmail: 'diana.morales@sena.edu.co',
    date: '2026-09-17',
    shift: '06:00',
    shiftLabel: '06:00 AM • Apertura de Taller',
    deadlineTime: '06:30 AM',
    ...
    verifiedCount: 4,
    missingCount: 0,
    completedAt: '06:10 AM',
    completedBy: 'Ing. Diana Marcela Morales',
    notes: 'Equipos en banco de diagnóstico revisados.',
    alertSent: false
  },
  {
    id: 'sched-serv-12',
    ...
    verifiedCount: 4,
    missingCount: 0,
    completedAt: '12:08 PM',
    completedBy: 'Ing. Diana Marcela Morales',
    notes: 'Control de inventario en mesa al mediodía.',
    alertSent: false
  },
  {
    id: 'sched-serv-18',
  ...
  // Almacén de Dañados
  {
    ...
    environmentName: 'Almacén de Dañados / Bajas',
    instructorId: 'usr-inst-5',
    instructorName: 'Custodio Roberto Gómez',
    instructorEmail: 'roberto.gomez@sena.edu.co',
    date: '2026-09-17',
    shift: '06:00',
    shiftLabel: '06:00 AM • Apertura de Taller',
    deadlineTime: '06:30 AM',
    ...
    verifiedCount: 2,
    missingCount: 0,
    completedAt: '06:20 AM',
    completedBy: 'Custodio Roberto Gómez',
    notes: 'Activos en cuarentena verificados en estantes.',
    alertSent: false
  },
  {
    id: 'sched-dam-12',
    ...
    completedBy: 'Custodio Roberto Gómez',
    notes: 'Sin novedades en almacén de bajas.',
    alertSent: false
  },
  {
    id: 'sched-dam-18',
...
export const INITIAL_ADMIN_EMAIL_ALERTS: AdminEmailAlert[] = [
  {
    id: 'alt-email-001',
    scheduleId: 'sched-amb2-12',
    environmentId: 'amb2',
    environmentName: 'Ambiente 2: Aula Cómputo & Redes',
    instructorName: 'Lic. Laura Sofía Vargas',
    instructorEmail: 'laura.vargas@sena.edu.co',
    adminEmail: 'javierpint@gmail.com',
    shift: '12:00',
    shiftLabel: 'Jornada Mediodía (12:00 M)',
    date: '2026-09-17',
    scheduledTime: '12:00 PM',
    deadlineTime: '12:30 PM',
    subject: '⚠️ [ALERTA INVENTARIO SENA] Incumplimiento de Toma Física - Ambiente 2: Aula Cómputo & Redes (Turno 12:00 M)',
    body: `Señor Administrador,\n\nLe notificamos formalmente que al cierre de la ventana horaria oficial (12:30 PM del día 17/09/2026), el instructor responsable asignado no ha registrado la toma física obligatoria de inventario:\n\n• Ambiente: Ambiente 2: Aula Cómputo & Redes\n• Instructor Asignado: Lic. Laura Sofía Vargas (laura.vargas@sena.edu.co)\n• Jornada Programada: 12:00 M (Tolerancia máxima hasta 12:30 PM)\n• Activos Bajo Custodia: 25 equipos serializados\n• Estado Actual: NO REALIZADA / VENCIDA\n\nPor favor proceda a contactar al instructor titular o delegar una comisión de auditoría inmediata para garantizar la custodia patrimonial de los activos asignados al ambiente.\n\nAtentamente,\nSistema Automatizado de Control de Inventarios SENA - ControlADSO\nNotificación enviada a: javierpint@gmail.com, admin@sena.edu.co`,
    sentAt: 'Hoy a las 12:31 PM',
    status: 'ENVIADO'
  },
  {
    id: 'alt-email-002',
    scheduleId: 'sched-amb3-06',
    environmentId: 'amb3',
    environmentName: 'Ambiente 3: Taller de Electrónica',
    instructorName: 'Prof. Fernando Ortiz',
    instructorEmail: 'fernando.ortiz@sena.edu.co',
    adminEmail: 'javierpint@gmail.com',
    shift: '06:00',
    shiftLabel: 'Jornada Mañana (06:00 AM)',
    date: '2026-09-17',
    scheduledTime: '06:00 AM',
    deadlineTime: '06:30 AM',
    subject: '⚠️ [ALERTA INVENTARIO SENA] Incumplimiento de Toma Física - Ambiente 3: Taller de Electrónica (Turno 06:00 AM)',
    body: `Señor Administrador,\n\nLe notificamos formalmente que al cierre de la ventana horaria oficial (06:30 AM del día 17/09/2026), el instructor responsable asignado no ha registrado la toma física obligatoria de inventario:\n\n• Ambiente: Ambiente 3: Taller de Electrónica\n• Instructor Asignado: Prof. Fernando Ortiz (fernando.ortiz@sena.edu.co)\n• Jornada Programada: 06:00 AM (Apertura de taller)\n• Activos Bajo Custodia: 11 equipos de laboratorio\n• Estado Actual: NO REALIZADA / VENCIDA\n\nAtentamente,\nSistema Automatizado de Control de Inventarios SENA - ControlADSO\nNotificación enviada a: javierpint@gmail.com, admin@sena.edu.co`,
    sentAt: 'Hoy a las 06:31 AM',
    status: 'ENVIADO'
  }
];
